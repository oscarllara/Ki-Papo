...
const AvatarCreator = ({ onSave, onCancel }: AvatarCreatorProps) => {
  ...
  const hairStyles = ['Topete', 'Franja', 'Longo', 'Careca', 'Arrepiado'];
  const skinTones = [
  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in duration-500">
      {/* Caricatura Vetorial Baseada na Imagem */}
      <div className="flex justify-center">
        <div className="relative w-56 h-64 flex flex-col items-center">
          ...
          <div className="relative w-32 h-40 z-20">
            ...
            {/* Rosto Principal */}
            <div 
              className="w-full h-full rounded-[35%_35%_45%_45%] shadow-lg relative overflow-hidden transition-all duration-500"
            ...
            >
              ...
              {/* Nariz e Boca (Formatos da imagem) */}
            ...
            {/* Cabelo (Estilo vetorial em camadas) */}
        ...
        <div className="space-y-6">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Input 
                ...
                className="w-20 h-9 text-center font-black border-slate-200 rounded-xl bg-slate-50 focus:ring-[#2377bb]/20"
              />
            </div>
            <input 
          ...
          <div className={cn(
            ...
            <Label className="text-sm font-black text-slate-700 flex items-center gap-3 cursor-pointer">
              <Glasses size={20} className={traits.glasses ? "text-[#2377bb]" : "text-slate-400"} /> Adicionar óculos?
            </Label>
          </div>
        </div>
